...
model_dict = dict(
            ResNet10=methods.backbone.ResNet10)

def parse_args(script):
    parser = argparse.ArgumentParser(description= 'few-shot script %s' %(script))
    parser.add_argument('--distractor', default=True, help='training with distractor')
    parser.add_argument('--mtce', default=False, help='training with mtce_loss')
